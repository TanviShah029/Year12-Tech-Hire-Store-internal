...
def search():
    if not etry.winfo_viewable():
        ...
        if text == "hire":
            ...
            messagebox.showerror("Error", "Type Hire or return.")
...
def view_receipt_page():
    ...
    def view_receipt():
     ...
     # All purchases shown in the cart.
        ...
        bar_btn_close.place(relx=0.38, rely=0.85)
...
bar_btn_computer_accessories.place(relx= 0.55, rely=0.70)
...
bar_btn_save.place(relx= 0.25, rely=0.70)
...
def accessories_return():
    ...
    def lkup_customer_run(mode_action):
        ...
        full_name_of_cust.config(text="Customer name: " + customer_info["first_name"] + " " + customer_info["last_name"])
