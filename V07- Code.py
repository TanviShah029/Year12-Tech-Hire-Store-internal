...
def view_receipt_page():
    ...
    def view_receipt():
        ...
        receipt_label.pack()
        receipt_label.place(relx=0.10, rely=0.20)

        receipt_entry=Entry(view_receipt_win, textvariable=receipt_variable, state="readonly",bg=L_BLUE,width=20)
        receipt_entry.pack()
        receipt_entry.place(relx=0.55, rely=0.20)
        Label(view_receipt_win, text=("----------------------"), bg = L_BLUE).place(relx= 0.34, rely=0.30)
        ...
        for x in cart:
            price = ACCESSORIES[x] [1]
            total = total + price
            Label(view_receipt_win, text=x + " - $" + str(price), font=("Arial", 11, "bold"), bg = L_BLUE).place(relx = 0.30, rely= y)
            y += 0.05

            Label(view_receipt_win, text=("----------------------"), bg = L_BLUE).place(relx= 0.34, rely=0.55)
            total_Label = Label(view_receipt_win, text="Total $ " + str(total), font=("Arial", 13, "bold"), bg = L_BLUE, fg=NVY_BLUE)
            total_Label.place(relx = 0.34, rely= 0.63)
            Label(view_receipt_win, text=("----------------------"), bg = L_BLUE).place(relx= 0.34, rely=0.70)
            Label(view_receipt_win, text=("THANK YOU 😊"), bg = L_BLUE, font=("Arial", 18, "bold")).place(relx= 0.26, rely=0.75)
